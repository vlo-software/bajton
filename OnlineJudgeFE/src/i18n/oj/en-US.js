export const m = {
  ...
  Vim_enabled: 'Vim key bindings enabled.',
  Sublime_enabled: 'Sublime key bindings enabled.',
  Are_you_sure_you_want_to_enable_vim:
    "Are you sure you want to enable Vim key bindings?<br/><br/><em>You probably don't.</em><br/><br/>If you choose to click ok and get stuck, you can always go back to the sublime key bindings by clicking on the Vim button again.",
  Monokai: 'Monokai',
